...
namespace TimingMadShoken
{
	...
	public class mainForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            // 
            this.récupererParFtpToolStripMenuItem.Enabled = false;
            ...
            this.récupererParFtpToolStripMenuItem.Visible = false;
            ...
            this.duringColorPanel.Paint += new System.Windows.Forms.PaintEventHandler(this.duringColorPanel_Paint);
            // 
            // afterColorPanel
            // 
       ...
       // private void setVideoPosition()
        ...
        {
            prevColorPanel_BackColorChanged(sender, e);
        }
        ...
        private void envoyerParFtpToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (infoTime.name.Trim().Length == 0)
            {
            ...
            else
            {
                ...
                //this.Enabled = false;
                ftpForm.setInfo(this.paroleManager, this.videoFilepath, infoTime.name);
        ...
        private void duringColorPanel_Paint(object sender, PaintEventArgs e)
        {
            prevColorPanel_BackColorChanged(sender, e);
        }
